...
export default function DigitalAssaultSection() {
    ...
    <section className="relative py-12 md:py-16 bg-black overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-lg font-medium text-zinc-400 max-w-2xl mx-auto leading-relaxed">
            Standard monitors emit a jagged, high-energy visible (HEV) blue light spike that mimics
            the intensity of the high-noon sun — hammering your retinas for 8+ hours a day.
          </p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <g transform="translate(20, 70)">
                ...
                <rect x="36" y="84" width="28" height="8" rx="2" fill="rgb(63, 63, 70)" />
              </g>
              ...
              <g transform="translate(390, 50)">
                ...
                />
                <ellipse cx="70" cy="50" rx="22" ry="14" fill="rgb(39, 39, 42)" />
                <ellipse cx="76" cy="44" rx="6" ry="4" fill="white" opacity="0.9" />
                <path
                  d="M 10 35 L 18 28 M 130 38 L 138 32 M 25 10 L 32 5 M 115 90 L 122 98 M 5 55 L 12 62 M 135 45 L 142 52 M 40 5 L 48 12 M 100 95 L 92 102"
                  stroke="rgb(249, 115, 22)"
                  strokeWidth="2.5"
                  strokeOpacity="0.7"
                  strokeLinecap="round"
                />
                <path
                  d="M 35 25 L 42 22 L 48 28 M 105 30 L 98 35 L 92 28 M 50 70 L 58 75 L 65 68 M 90 72 L 82 78 L 75 70"
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {cards.map((card, i) => {
            ...
            return (
              <motion.div
                key={card.title}
                className="relative overflow-hidden rounded-2xl p-6 bg-mustafar-card border-2 border-amber-500/30 hover:border-amber-500/50 transition-all duration-300"
              ...
              >
                <span className="inline-block px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider mb-3 bg-amber-500/20 text-amber-400">
                  {card.harm}
                </span>
